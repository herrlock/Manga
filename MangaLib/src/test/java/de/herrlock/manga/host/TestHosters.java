...
public class TestHosters {
    ...
    public void testGetHostByURL1() throws IOException {
        ...
        Hoster hoster = Hosters.getHostByURL( url );
    ...
    public void testEquals() throws IOException {
        Hoster hoster1 = Hosters.getHostByURL( new URL( "http://mangapanda.com" ) );
        Hoster hoster2 = Hosters.getHostByURL( new URL( "http://mangapanda.com" ) );
    ...
    public void testNotEquals3() throws IOException {
        Hoster hoster1 = Hosters.getHostByURL( new URL( "http://mangapanda.com" ) );
        Hoster hoster2 = Hosters.getHostByURL( new URL( "http://mangafox.me" ) );
        boolean equals = hoster1.equals( hoster2 );
        Assert.assertFalse( equals );
    }
